...
def parseRooms(txt_string):
	'''
	read a rooms txt file, returns a list of Room objects
	'''
	reader = csv.reader(StringIO(txt_string), delimiter = " ", quotechar = '"')
	data = list(reader)
...
def parseEvents(txt_string):
	'''
	read an events txt file, returns a list of Events
	'''
	reader = csv.reader(StringIO(txt_string), delimiter = " ", quotechar = '"')
	data = list(reader)
